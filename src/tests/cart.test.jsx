...
const createTestStore = (
  initialCartState = { items: [], total: 0, discount: 0 }
) => {
...
describe('Cart - Integration Tests (CartPage Component)', () => {
  ...
  it('should display empty cart message when cart is empty', () => {
    ...
    expect(
      screen.getByText('Ajoutez des articles pour commencer vos achats')
    ).toBeInTheDocument()
  })
  ...
  it('should call updateCartItem when quantity is changed', () => {
    ...
    expect(mockUpdateCartItem.mutate).toHaveBeenCalledWith({
      productId: 'product1',
      quantity: 3,
    })
  })
  ...
  it('should call removeCartItem when remove button is clicked', () => {
    ...
    expect(mockRemoveCartItem.mutate).toHaveBeenCalledWith({
      productId: 'product1',
    })
  })
  ...
  it('should disable decrease button when quantity is 1', () => {
    ...
    const minusButton = decreaseButtons.find(
      (btn) => btn.querySelector('svg') && btn.disabled === true
    )
  ...
  it('should show error state', () => {
    ...
    expect(
      screen.getByText('Impossible de charger votre panier.')
    ).toBeInTheDocument()
  })
})
