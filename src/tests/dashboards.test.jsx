...
describe('Dashboard Role-Based Rendering', () => {
  ...
  describe('SellerPage - Seller Role (role="seller")', () => {
    ...
    it('should NOT render SellerPage when user has role="user"', () => {
      ...
      expect(screen.getByTestId('home-page')).toBeInTheDocument()
      expect(
        screen.queryByText(/Seller Dashboard Overview/i)
            ...
            <Routes>
              ...
              >
                <Route
                  index
                  element={
                    <div data-testid="admin-overview">Admin Overview</div>
                  }
                />
              </Route>
              <Route
          ...
          <MemoryRouter initialEntries={['/admin']}>
            <Routes>
              ...
              >
                <Route
                  index
                  element={<div data-testid="admin-overview">Overview</div>}
                />
              </Route>
              <Route
                path="/"
