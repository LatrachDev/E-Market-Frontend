    ...
    <div className="flex flex-col gap-10">
      <header>
        ...
        <p className="mt-2 text-sm font-montserrat text-gray-600">
          Browse and inspect products from the database.
        </p>
      </header>
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm font-montserrat text-gray-500">
              Click "View" to inspect product details.
            </p>
          </div>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="rounded-full border border-brandRed px-3 py-1 text-xs font-semibold font-montserrat text-brandRed hover:bg-brandRed hover:text-white transition"
                      >
                        View
                      </Link>
                    </div>
