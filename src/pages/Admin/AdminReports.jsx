...
const exports = [
  {
    ...
    description: 'CSV · Last generated 2h ago',
  },
  {
    title: 'Channel Contribution Report',
    description: 'Excel · Last generated yesterday',
  },
  {
    title: 'Cohort Retention Snapshot',
    description: 'PDF · Last generated 5d ago',
  },
]
    ...
    <div className="flex flex-col gap-10">
      <header>
        ...
        <p className="mt-2 text-sm font-montserrat text-gray-600">
          Monitor performance KPIs and generate shareable reports for finance,
          CX, and product.
        </p>
      </header>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {metrics.map((metric) => (
          <div
            key={metric.label}
            className="rounded-3xl border border-brandRed/10 bg-white p-6 shadow-sm"
          >
            <p className="text-sm font-montserrat text-gray-500">
              {metric.label}
            </p>
            <p className="mt-2 text-3xl font-playfair font-semibold text-gray-900">
              {metric.value}
            </p>
