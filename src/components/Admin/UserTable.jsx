...
const UserTable = memo(
  ({ users, onUpdate, onDelete, page, setPage, totalPages }) => {
              ...
              <div className="flex items-center justify-between gap-6 flex-wrap">
                <div className="flex items-center gap-6 flex-1 min-w-0">
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    <div
                      className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-white ${getRoleColor(user.role)}`}
                    ></div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    {editingId === user._id ? (
                      ...
                      <div
                        className={`flex items-center gap-2 px-4 py-2 rounded-full ${getRoleBadge(user.role)}`}
                      >
                        <div
