      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-8">
            {/* Main Heading */}
            <h2 className="text-3xl text-brandRed font-playfair sm:text-4xl lg:text-5xl font-bold leading-tight">
              Discover the Difference Our Cosmetics Make
            </h2>

            {/* Brand Philosophy */}
            <p className="text-lg font-montserrat sm:text-xl leading-relaxed opacity-90">
              At SI K-Beauty, we believe that true beauty comes from products
              that not only enhance your appearance but also align with your
              values and respect the world around us.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-montserrat opacity-90 leading-relaxed">
                  Committed to environmental responsibility with sustainable
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-montserrat opacity-90 leading-relaxed">
                  Beauty products designed for all skin types and tones,
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm opacity-90 font-montserrat leading-relaxed">
                  Rigorously tested formulations using only the finest
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-montserrat opacity-90 leading-relaxed">
                  Enhancing your natural beauty to help you feel confident and
                  radiant every day.
                </p>
              </div>
            </div>
            ...
            <div className="bg-linear-to-br from-[#F5F5DC] to-[#F0E68C] rounded-t-3xl rounded-b-3xl p-8 lg:p-12 relative overflow-hidden">
              ...
              <div className="absolute top-6 right-6 z-10 bg-white rounded-xl px-4 py-3 shadow-lg">
                <div className="text-center">
                  <div className="text-2xl font-montserrat font-bold text-gray-800">
                    98%
                  </div>
