        ...
        >
          <div className="flex-1 flex flex-col justify-center text-center">
            ...
            <p className="font-dm text-sm leading-relaxed px-2">
              A brightening ampoule that balances tone and refines the look of
              pores for glowy, radiant skin
            </p>
          </div>

          <Link
            to={'/login'}
            className="text-center w-full bg-white cursor-pointer text-black py-3 font-dm text-base font-medium hover:bg-hoverBrandRed hover:text-brandWhite transition-all duration-300 transform hover:scale-105"
          >
            Add To Cart - $15.40
          </Link>
        </div>
