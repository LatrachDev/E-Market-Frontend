...
//     loading,
//     error,
//     fetchSellerOrders,           // fetch React Query
//     updateOrderStatusMutation,   // mutation React Query
//   } = useSellerOrders();
...
//                       <span>
//                         Prix :{" "}
//                         <strong className="text-brandRed">{item.price} MAD</strong>
//                       </span>
//                     </div>

//                     <div className="mt-2 text-sm text-gray-700">
//                       Sous-total : <strong>{item.price * item.quantity} MAD</strong>
//                     </div>
//                   </div>
//                 ))}
//               </div>
